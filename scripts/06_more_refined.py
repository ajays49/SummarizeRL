"""
Stage 6: More refined
Same pipeline as stage 5 (section cleaning + multi-iteration abstractive
summarization scored against a reference summary), with two tweaks:
3 sentences are extracted per page instead of 2, and both max_length and
the ROUGE-L score get a small random jitter to add iteration-to-iteration
variation.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Section-cleaned, multi-iteration abstractive summarization (with jitter).")
